# 1 "../partidaEstrelaTriangulo.X/delay.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../partidaEstrelaTriangulo.X/delay.c" 2
...
# 9 "../partidaEstrelaTriangulo.X/delay.c" 2

# 1 "../partidaEstrelaTriangulo.X/config.h" 1
...
# 10 "../partidaEstrelaTriangulo.X/delay.c" 2
